...
If fso.FileExists(wt) Then
  cmd = "cmd /c start """" wt.exe -d """ & dir & """ powershell -NoProfile -ExecutionPolicy Bypass -File """ & dir & "\06-kfai-launch.ps1"" -App opencode"
Else
  cmd = "powershell -NoProfile -ExecutionPolicy Bypass -File """ & dir & "\06-kfai-launch.ps1"" -App opencode"
End If
sh.Run cmd, 1, False
